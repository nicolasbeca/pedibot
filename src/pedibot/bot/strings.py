...
STRINGS: dict[str, Table] = {
    "en": {
        ...
        "banner_emergency_no_number": "🚨 Go to the nearest emergency department or health centre right now. There is no national emergency number to call in your country.",
        "banner_mental_no_number": "💛 This matters and you are not alone. If your child has already done something to harm themselves, go to the nearest emergency department or health centre now.",
        "photo_emergency_no_number": "I can see a possible warning sign ({sign}). According to the SEUP, this needs immediate care: go to the nearest emergency department or health centre now, especially if breathing is difficult.",
        "photo_sign_cyanosis": "blue/grey lips or skin",
        "photo_sign_swelling": "swollen lips or eyelids",
        "photo_sign_petechiae": "spots on the skin",
    ...
    "es": {
        ...
        "vax_source": "Fuente: ",
        "vax_checked": " (comprobado el {date})",
        ...
        "banner_emergency_no_number": "🚨 Ve ahora mismo al hospital o centro de salud más cercano. En tu país no hay un número nacional de emergencias al que llamar.",
        "banner_mental_no_number": "💛 Esto es importante y no estás solo/a. Si el menor ha hecho algo para hacerse daño, ve ahora al hospital o centro de salud más cercano.",
        "photo_emergency_no_number": "Veo un posible signo de alarma ({sign}). Según la SEUP, esto requiere atención inmediata: ve ahora al hospital o centro de salud más cercano, sobre todo si le cuesta respirar.",
        "photo_sign_cyanosis": "labios o piel azulados",
        "photo_sign_swelling": "hinchazón de labios o párpados",
        "photo_sign_petechiae": "manchas en la piel",
    ...
    "fr": {
        ...
        "banner_emergency_no_number": "🚨 Allez tout de suite à l'hôpital ou au centre de santé le plus proche. Il n'y a pas de numéro d'urgence national à appeler dans votre pays.",
        "banner_mental_no_number": "💛 C'est important et vous n'êtes pas seul·e. Si votre enfant s'est déjà fait du mal, allez maintenant à l'hôpital ou au centre de santé le plus proche.",
        "photo_emergency_no_number": "Je vois un signe d'alerte possible ({sign}). Selon la SEUP, cela demande une prise en charge immédiate : allez maintenant à l'hôpital ou au centre de santé le plus proche, surtout si la respiration est difficile.",
        "photo_sign_cyanosis": "lèvres ou peau bleutées ou grises",
        "photo_sign_swelling": "lèvres ou paupières gonflées",
        "photo_sign_petechiae": "des taches sur la peau",
    ...
    "de": {
        ...
        "banner_emergency_no_number": "🚨 Fahren Sie sofort in das nächste Krankenhaus oder Gesundheitszentrum. In Ihrem Land gibt es keine landesweite Notrufnummer.",
        "banner_mental_no_number": "💛 Das ist wichtig, und Sie sind nicht allein. Wenn Ihr Kind sich bereits etwas angetan hat, fahren Sie jetzt in das nächste Krankenhaus oder Gesundheitszentrum.",
        "photo_emergency_no_number": "Ich sehe ein mögliches Warnzeichen ({sign}). Laut SEUP braucht das sofortige Hilfe: Fahren Sie jetzt in das nächste Krankenhaus oder Gesundheitszentrum, besonders wenn die Atmung schwerfällt.",
        "photo_sign_cyanosis": "bläuliche oder graue Lippen oder Haut",
        "photo_sign_swelling": "geschwollene Lippen oder Augenlider",
        "photo_sign_petechiae": "Flecken auf der Haut",
    ...
    "ru": {
        ...
        "banner_emergency_no_number": "🚨 Немедленно везите ребёнка в ближайшую больницу или медицинский пункт. Единого номера экстренных служб в вашей стране нет.",
        "banner_mental_no_number": "💛 Это важно, и вы не одни. Если ребёнок уже причинил себе вред, немедленно везите его в ближайшую больницу или медицинский пункт.",
        "photo_emergency_no_number": "Я вижу возможный тревожный признак ({sign}). По рекомендациям SEUP это требует немедленной помощи: везите ребёнка в ближайшую больницу или медицинский пункт, особенно если ему трудно дышать.",
        "photo_sign_cyanosis": "синюшные или серые губы либо кожа",
        "photo_sign_swelling": "отёк губ или век",
        "photo_sign_petechiae": "пятна на коже",
    ...
    "ar": {
        ...
        "banner_emergency_no_number": "🚨 توجّه الآن إلى أقرب مستشفى أو مركز صحي. لا يوجد في بلدك رقم طوارئ وطني للاتصال به.",
        "banner_mental_no_number": "💛 هذا أمر مهم ولست وحدك. إذا كان الطفل قد آذى نفسه بالفعل فتوجّه الآن إلى أقرب مستشفى أو مركز صحي.",
        "photo_emergency_no_number": "أرى علامة خطر محتملة ({sign}). وفق SEUP يحتاج هذا إلى رعاية فورية: توجّه الآن إلى أقرب مستشفى أو مركز صحي، خاصة إذا كان التنفس صعبا.",
        "photo_sign_cyanosis": "شفاه أو جلد بلون أزرق أو رمادي",
        "photo_sign_swelling": "تورم في الشفتين أو الجفون",
        "photo_sign_petechiae": "بقع على الجلد",
    ...
    "pt": {
        ...
        "banner_emergency_no_number": "🚨 Vá agora mesmo ao hospital ou centro de saúde mais próximo. No seu país não há um número nacional de emergência para ligar.",
        "banner_mental_no_number": "💛 Isto é importante e não está sozinho. Se a criança já fez algo para se magoar, vá agora ao hospital ou centro de saúde mais próximo.",
        "photo_emergency_no_number": "Vejo um possível sinal de alarme ({sign}). Segundo a SEUP, isto exige atenção imediata: vá agora ao hospital ou centro de saúde mais próximo, sobretudo se estiver com dificuldade em respirar.",
        "photo_sign_cyanosis": "lábios ou pele arroxeados",
        "photo_sign_swelling": "inchaço nos lábios ou nas pálpebras",
        "photo_sign_petechiae": "manchas na pele",
    ...
    "hi": {
        ...
        "banner_emergency_no_number": "🚨 अभी नज़दीकी अस्पताल या स्वास्थ्य केंद्र जाएँ। आपके देश में कॉल करने के लिए कोई राष्ट्रीय आपातकालीन नंबर नहीं है।",
        "banner_mental_no_number": "💛 यह ज़रूरी है और आप अकेले नहीं हैं। अगर बच्चे ने ख़ुद को नुक़सान पहुँचाया है, तो अभी नज़दीकी अस्पताल या स्वास्थ्य केंद्र जाएँ।",
        "photo_emergency_no_number": "मुझे ख़तरे का एक संभावित लक्षण दिख रहा है ({sign})। SEUP के अनुसार इसे तुरंत देखभाल चाहिए: अभी नज़दीकी अस्पताल या स्वास्थ्य केंद्र जाएँ, ख़ासकर अगर साँस लेने में तकलीफ़ हो।",
        "photo_sign_cyanosis": "होंठ या त्वचा का नीला पड़ना",
        "photo_sign_swelling": "होंठ या पलकों की सूजन",
        "photo_sign_petechiae": "त्वचा पर दाने",
    ...
    "sw": {
        ...
        "vax_source": "Chanzo: ",
        "vax_checked": " (ilihakikiwa tarehe {date})",
