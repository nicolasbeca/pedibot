...
STRINGS: dict[str, Table] = {
    "en": {
        ...
        "vax_source": "Source: ",
        "muac_head": "Arm measurement: {mm}.",
        "muac_severe": "Below 115 mm is severe acute malnutrition, according to the WHO.",
        "muac_moderate": "Between 115 and 125 mm is moderate acute malnutrition, according to the WHO.",
        "muac_ok": "125 mm or more does not fall into either of the WHO's two bands. The tape screens; it does not say the child is well fed.",
        "muac_go": "Take the child to a health centre today. This needs treatment, and the sooner it starts the better it goes.",
        "muac_also": "The tape and the weight-for-height chart find different children, so the WHO asks for both when there is a scale.",
        "emgq_number": "In {country}, the emergency number is {number}.",
        "emgq_none": "In {country} there is no national emergency number: go straight to the nearest hospital or health centre.",
        "emgq_unsure": "I have not been able to verify a national emergency number for {country} from a published source.",
        "emgq_poison": "Poison control: {number}.",
        "emgq_mental": "Mental health line: {number}.",
    ...
    "es": {
        ...
        "vax_source": "Fuente: ",
        "muac_head": "Medida del brazo: {mm}.",
        "muac_severe": "Por debajo de 115 mm es desnutrición aguda grave, según la OMS.",
        "muac_moderate": "Entre 115 y 125 mm es desnutrición aguda moderada, según la OMS.",
        "muac_ok": "125 mm o más no cae en ninguna de las dos franjas de la OMS. La cinta criba, no dice que el niño esté bien alimentado.",
        "muac_go": "Llévalo hoy a un centro de salud. Esto necesita tratamiento, y cuanto antes empiece, mejor va.",
        "muac_also": "La cinta y la curva de peso para la talla encuentran niños distintos, así que la OMS pide las dos cuando hay báscula.",
        "emgq_number": "En {country}, el número de urgencias es el {number}.",
        "emgq_none": "En {country} no hay número nacional de urgencias: ve directamente al hospital o al centro de salud más cercano.",
        "emgq_unsure": "No he podido verificar un número nacional de urgencias para {country} en ninguna fuente publicada.",
        "emgq_poison": "Toxicología: {number}.",
        "emgq_mental": "Línea de salud mental: {number}.",
    ...
    "fr": {
        ...
        "vax_source": "Source : ",
        "muac_head": "Mesure du bras : {mm}.",
        "muac_severe": "En dessous de 115 mm, c'est une malnutrition aiguë sévère, selon l'OMS.",
        "muac_moderate": "Entre 115 et 125 mm, c'est une malnutrition aiguë modérée, selon l'OMS.",
        "muac_ok": "125 mm ou plus ne tombe dans aucune des deux bandes de l'OMS. Le ruban dépiste ; il ne dit pas que l'enfant est bien nourri.",
        "muac_go": "Emmenez l'enfant aujourd'hui dans un centre de santé. Cela demande un traitement, et plus tôt il commence, mieux cela se passe.",
        "muac_also": "Le ruban et la courbe poids-taille repèrent des enfants différents : l'OMS demande les deux quand il y a une balance.",
        "emgq_number": "Au {country}, le numéro d'urgence est le {number}.",
        "emgq_none": "Dans ce pays ({country}) il n'y a pas de numéro d'urgence national : allez directement à l'hôpital ou au centre de santé le plus proche.",
        "emgq_unsure": "Je n'ai pas pu vérifier de numéro d'urgence national pour ce pays ({country}) dans une source publiée.",
        "emgq_poison": "Centre antipoison : {number}.",
        "emgq_mental": "Ligne de santé mentale : {number}.",
    ...
    "de": {
        ...
        "vax_source": "Quelle: ",
        "muac_head": "Oberarmumfang: {mm}.",
        "muac_severe": "Unter 115 mm ist laut WHO eine schwere akute Mangelernährung.",
        "muac_moderate": "Zwischen 115 und 125 mm ist laut WHO eine mäßige akute Mangelernährung.",
        "muac_ok": "125 mm oder mehr fällt in keine der beiden WHO-Kategorien. Das Band screent; es sagt nicht, dass das Kind gut ernährt ist.",
        "muac_go": "Gehen Sie heute mit dem Kind in eine Gesundheitseinrichtung. Das braucht Behandlung, und je früher sie beginnt, desto besser.",
        "muac_also": "Band und Gewichts-Längen-Kurve finden unterschiedliche Kinder; die WHO verlangt beides, wenn eine Waage da ist.",
        "emgq_number": "In {country} lautet die Notrufnummer {number}.",
        "emgq_none": "In {country} gibt es keine landesweite Notrufnummer: Gehen Sie direkt zum nächsten Krankenhaus oder Gesundheitszentrum.",
        "emgq_unsure": "Ich konnte für {country} keine landesweite Notrufnummer in einer veröffentlichten Quelle bestätigen.",
        "emgq_poison": "Giftnotruf: {number}.",
        "emgq_mental": "Krisendienst: {number}.",
    ...
    "ru": {
        ...
        "vax_source": "Источник: ",
        "muac_head": "Окружность плеча: {mm}.",
        "muac_severe": "Меньше 115 мм — тяжёлая острая недостаточность питания, по данным ВОЗ.",
        "muac_moderate": "От 115 до 125 мм — умеренная острая недостаточность питания, по данным ВОЗ.",
        "muac_ok": "125 мм и больше не попадает ни в одну из двух категорий ВОЗ. Лента — это скрининг, она не говорит, что ребёнок хорошо питается.",
        "muac_go": "Отведите ребёнка в медицинское учреждение сегодня. Это требует лечения, и чем раньше оно начнётся, тем лучше.",
        "muac_also": "Лента и кривая «вес к росту» находят разных детей, поэтому ВОЗ просит оба измерения, когда есть весы.",
        "emgq_number": "В стране {country} номер экстренной службы — {number}.",
        "emgq_none": "В стране {country} нет единого номера экстренной службы: идите прямо в ближайшую больницу или поликлинику.",
        "emgq_unsure": "Мне не удалось подтвердить единый номер экстренной службы для страны {country} по опубликованному источнику.",
        "emgq_poison": "Токсикологическая служба: {number}.",
        "emgq_mental": "Служба психологической помощи: {number}.",
    ...
    "ar": {
        ...
        "vax_source": "المصدر: ",
        "muac_head": "محيط الذراع: {mm}.",
        "muac_severe": "أقل من 115 مم سوء تغذية حاد وخيم، وفق منظمة الصحة العالمية.",
        "muac_moderate": "من 115 إلى 125 مم سوء تغذية حاد متوسط، وفق منظمة الصحة العالمية.",
        "muac_ok": "125 مم فأكثر لا يقع في أي من الفئتين. الشريط أداة فرز، ولا يقول إن الطفل حسن التغذية.",
        "muac_go": "خذ الطفل اليوم إلى مركز صحي. هذه الحالة تحتاج علاجا، وكلما بدأ مبكرا كان أفضل.",
        "muac_also": "الشريط ومنحنى الوزن للطول يكتشفان أطفالا مختلفين، ولذلك تطلب المنظمة القياسين معا حين يتوفر ميزان.",
        "emgq_number": "في {country}، رقم الطوارئ هو {number}.",
        "emgq_none": "في {country} لا يوجد رقم طوارئ وطني: اذهب مباشرة إلى أقرب مستشفى أو مركز صحي.",
        "emgq_unsure": "لم أتمكن من التحقق من وجود رقم طوارئ وطني لـ {country} في مصدر منشور.",
        "emgq_poison": "مركز السموم: {number}.",
        "emgq_mental": "خط الصحة النفسية: {number}.",
    ...
    "pt": {
        ...
        "vax_source": "Fonte: ",
        "muac_head": "Medida do braço: {mm}.",
        "muac_severe": "Abaixo de 115 mm é desnutrição aguda grave, segundo a OMS.",
        "muac_moderate": "Entre 115 e 125 mm é desnutrição aguda moderada, segundo a OMS.",
        "muac_ok": "125 mm ou mais não cai em nenhuma das duas faixas da OMS. A fita rastreia; não diz que a criança está bem alimentada.",
        "muac_go": "Leve a criança hoje a um centro de saúde. Isto precisa de tratamento, e quanto mais cedo começar, melhor corre.",
        "muac_also": "A fita e a curva de peso para a estatura encontram crianças diferentes, por isso a OMS pede as duas quando há balança.",
        "emgq_number": "Em {country}, o número de emergência é o {number}.",
        "emgq_none": "Em {country} não existe número nacional de emergência: vá diretamente ao hospital ou centro de saúde mais próximo.",
        "emgq_unsure": "Não consegui verificar um número nacional de emergência para {country} numa fonte publicada.",
        "emgq_poison": "Centro de intoxicações: {number}.",
        "emgq_mental": "Linha de saúde mental: {number}.",
    ...
    "hi": {
        ...
        "vax_source": "स्रोत: ",
        "muac_head": "बाजू की माप: {mm}।",
        "muac_severe": "115 मिमी से कम होना गंभीर तीव्र कुपोषण है, WHO के अनुसार।",
        "muac_moderate": "115 से 125 मिमी के बीच होना मध्यम तीव्र कुपोषण है, WHO के अनुसार।",
        "muac_ok": "125 मिमी या उससे ज़्यादा WHO की इन दो श्रेणियों में नहीं आता। फ़ीता जाँच का साधन है; यह नहीं कहता कि बच्चा अच्छी तरह पोषित है।",
        "muac_go": "बच्चे को आज ही स्वास्थ्य केंद्र ले जाएँ। इसका इलाज ज़रूरी है, और जितनी जल्दी शुरू हो उतना बेहतर।",
        "muac_also": "फ़ीता और वज़न-लंबाई का वक्र अलग-अलग बच्चों को पकड़ते हैं, इसलिए तराज़ू हो तो WHO दोनों माँगता है।",
        "emgq_number": "{country} में आपातकालीन नंबर {number} है।",
        "emgq_none": "{country} में कोई राष्ट्रीय आपातकालीन नंबर नहीं है: सीधे निकटतम अस्पताल या स्वास्थ्य केंद्र जाएँ।",
        "emgq_unsure": "{country} के लिए किसी प्रकाशित स्रोत में राष्ट्रीय आपातकालीन नंबर की पुष्टि मैं नहीं कर सका।",
        "emgq_poison": "ज़हर नियंत्रण: {number}।",
        "emgq_mental": "मानसिक स्वास्थ्य हेल्पलाइन: {number}।",
    ...
    "sw": {
        ...
        "vax_source": "Chanzo: ",
        "muac_head": "Mzunguko wa mkono: {mm}.",
        "muac_severe": "Chini ya mm 115 ni utapiamlo mkali sana, kwa mujibu wa WHO.",
        "muac_moderate": "Kati ya mm 115 na 125 ni utapiamlo mkali wa wastani, kwa mujibu wa WHO.",
        "muac_ok": "Mm 125 au zaidi haiingii katika makundi mawili ya WHO. Utepe ni kwa uchunguzi; hausemi kuwa mtoto amelishwa vizuri.",
        "muac_go": "Mpeleke mtoto kituo cha afya leo. Hali hii inahitaji matibabu, na mapema ndio bora.",
        "muac_also": "Utepe na mkunjo wa uzito kwa urefu hupata watoto tofauti, hivyo WHO huomba vyote viwili pale kuna mizani.",
        "emgq_number": "Nchini {country}, namba ya dharura ni {number}.",
        "emgq_none": "Nchini {country} hakuna namba ya dharura ya kitaifa: nenda moja kwa moja hospitali au kituo cha afya kilicho karibu.",
        "emgq_unsure": "Sikuweza kuthibitisha namba ya dharura ya kitaifa ya {country} kutoka chanzo kilichochapishwa.",
        "emgq_poison": "Kituo cha sumu: {number}.",
        "emgq_mental": "Msaada wa afya ya akili: {number}.",
