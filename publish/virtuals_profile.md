...
- Cost per answer measured: ~$0.0004.
...
- Monthly public report: cost, questions answered, what was built, what the reserve did.
...
- **Stack:** Python, SQLite full-text index, DeepSeek V4 as the writing model behind a swappable interface, Astro static site, one small VPS. Running cost ≈ €10/month.
...
- **Funds the service.** The project reserve pays the server and the AI answers. Each month we publish what PediBot cost, how many questions it answered and what was built — with on-chain transactions for every movement of the reserve.
