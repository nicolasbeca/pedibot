...
CASOS = [
 ("manchas → no desaparecen", {
  ...
  "fr": ("elle a des taches rouges sur le ventre", "elles ne disparaissent pas quand j'appuie"),
 ...
 ("barriga → lado derecho", {
  "en": ("his tummy has been hurting since this morning", "now it hurts more on the right side"),
  "es": ("le duele la barriga desde esta mañana", "ahora le duele más en el lado derecho"),
  "fr": ("il a mal au ventre depuis ce matin", "maintenant ça fait plus mal du côté droit"),
  "de": ("er hat seit heute Morgen Bauchschmerzen", "jetzt tut es mehr auf der rechten Seite weh"),
...
TRANQUILAS = [
 ("catarro → duda", {
  "en": ("my child has a runny nose and a mild cough", "can I give him something to sleep better?"),
  "es": ("mi hijo tiene mocos y algo de tos", "¿le puedo dar algo para dormir mejor?"),
  "fr": ("mon enfant a le nez qui coule et un peu de toux", "puis-je lui donner quelque chose ?"),
  "de": ("mein Kind hat Schnupfen und etwas Husten", "kann ich ihm etwas zum Schlafen geben?"),
