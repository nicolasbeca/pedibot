...
CASOS: dict[str, str] = {
    ...
    "priapism": "mtoto wangu uume wake umesimama kwa saa nyingi",
    "paraphimosis": "govi la mtoto wangu limekwama nyuma",
    "sting_mouth_throat_eye": "mtoto wangu ameumwa na nyuki mdomoni",
    "pale_stools": "mtoto wangu ana kinyesi cheupe sana",
    "headache_wakes_child": "mtoto wangu maumivu ya kichwa yanamwamsha usiku",
    "unexplained_bruising": "mtoto wangu ana michubuko bila kugongwa na kitu",
    "unequal_pupils": "mtoto wangu ana mboni moja kubwa kuliko nyingine",
    "limp_after_fall": "mtoto wangu anachechemea baada ya kuanguka jana",
...
SEGUNDA: dict[str, str] = {
    ...
    "priapism": "uume wa mtoto umesimama kwa muda mrefu na ana maumivu",
    "paraphimosis": "baada ya kuoga govi la mtoto halirudi",
    "sting_mouth_throat_eye": "mtoto ameumwa na mdudu karibu na jicho",
    "pale_stools": "kinyesi cha mtoto kimefifia kwa siku tatu",
    "headache_wakes_child": "mtoto wangu ana maumivu ya kichwa anapoamka asubuhi",
    "unexplained_bruising": "mtoto wangu ana michubuko mwilini bila sababu yoyote",
    "unequal_pupils": "mtoto wangu ana mboni yake moja kubwa kuliko nyingine tangu jioni",
    "limp_after_fall": "mtoto wangu anachechemea tangu alianguka bustanini jana",
