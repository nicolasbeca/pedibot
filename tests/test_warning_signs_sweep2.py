...
ALARMA = [
 ("atragantamiento", "emergency", {
  "en": "my son is choking on a grape", "es": "mi hijo se está atragantando con una uva",
  "fr": "mon fils s'étouffe avec un raisin", "de": "mein Sohn erstickt an einer Weintraube",
  "ru": "сын подавился виноградиной", "ar": "ابني يختنق بحبة عنب",
  "pt": "meu filho está engasgado com uma uva", "hi": "मेरा बेटा अंगूर से दम घुट रहा है"}),
 ("sangrado que no para", "emergency", {
  "en": "the cut won't stop bleeding", "es": "la herida no deja de sangrar",
  "fr": "la plaie n'arrête pas de saigner", "de": "die Wunde hört nicht auf zu bluten",
  "ru": "рана не перестаёт кровоточить", "ar": "الجرح لا يتوقف عن النزيف",
  "pt": "o corte não para de sangrar", "hi": "घाव से खून नहीं रुक रहा"}),
 ("golpe cabeza + inconsciencia", "emergency", {
  ...
  "ru": "упал и ненадолго потерял сознание", "ar": "سقط وفقد الوعي للحظة",
  "pt": "caiu e perdeu a consciência por um momento",
  "hi": "वह गिरा और थोड़ी देर बेहोश हो गया"}),
 ("vómitos tras golpe en la cabeza", "urgent", {
  ...
  "ru": "ударился головой и дважды вырвало", "ar": "ارتطم رأسه وتقيأ مرتين",
  "pt": "bateu a cabeça e vomitou duas vezes", "hi": "सिर टकराया और दो बार उल्टी की"}),
 ("piel moteada", "emergency", {
  "en": "his skin is mottled and grey", "es": "tiene la piel moteada y grisácea",
  "fr": "sa peau est marbrée et grise", "de": "seine Haut ist marmoriert und grau",
  "ru": "кожа мраморная и серая", "ar": "جلده مرقط ورمادي",
  "pt": "a pele está marmorizada e acinzentada", "hi": "त्वचा चितकबरी और भूरी है"}),
 ("quemadura", "urgent", {
  "en": "he burned his hand with boiling water", "es": "se ha quemado la mano con agua hirviendo",
  "fr": "il s'est brûlé la main avec de l'eau bouillante",
  "de": "er hat sich die Hand mit kochendem Wasser verbrannt",
  "ru": "обжёг руку кипятком", "ar": "أحرق يده بماء مغلي",
  "pt": "queimou a mão com água fervendo", "hi": "उबलते पानी से हाथ जल गया"}),
 ("sangre en las heces", "urgent", {
  "en": "there is blood in his stool", "es": "tiene sangre en las heces",
  "fr": "il y a du sang dans ses selles", "de": "er hat Blut im Stuhl",
  "ru": "кровь в стуле", "ar": "يوجد دم في البراز",
  "pt": "tem sangue nas fezes", "hi": "मल में खून है"}),
 ("adolescente deja de comer", "mental_health", {
...
NORMAL = [
 ("no quiere verdura", {
  "en": "my 4-year-old refuses to eat vegetables", "es": "mi hijo de 4 años no quiere comer verdura",
  "fr": "mon fils de 4 ans ne veut pas manger de légumes",
  "de": "mein 4-jähriger Sohn will kein Gemüse essen",
  "ru": "сын 4 лет не хочет есть овощи", "ar": "ابني عمره 4 سنوات لا يريد أكل الخضار",
 ...
 ("sarpullido que SÍ se va al apretar", {
  ...
  "ru": "сыпь бледнеет при надавливании", "ar": "عندها طفح يختفي عند الضغط عليه",
  "pt": "tem manchinhas que somem quando aperto", "hi": "दबाने पर मिट जाने वाले दाने हैं"}),
 ("le molesta el sol de la playa", {
  ...
  "ru": "яркое солнце на пляже режет ему глаза", "ar": "شمس الشاطئ القوية تزعج عينيه",
 ...
 ("le bajó la fiebre", {
  ...
  "pt": "dei paracetamol e a febre baixou", "hi": "पैरासिटामोल दिया और बुखार उतर गया"}),
 ("duerme y come bien", {
  ...
  "ru": "хорошо спит и ест, просто вопрос", "ar": "ينام جيدا ويأكل جيدا، عندي سؤال فقط",
 ...
 ("guardería y mocos", {
  ...
  "ru": "с началом сада каждый месяц насморк", "ar": "منذ الحضانة يصاب بالزكام كل شهر",
