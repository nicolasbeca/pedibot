...
ALARMA = [
    (
        ...
        "emergency",
        {
            "en": "one side of his mouth is drooping",
            "es": "tiene la boca torcida hacia un lado",
            "fr": "sa bouche est tordue d'un côté",
            "de": "sein Mund hängt auf einer Seite herunter",
            "ru": "у него перекосило рот",
            "ar": "فمه ملتوٍ إلى جهة واحدة",
            "pt": "a boca dele está torta para um lado",
            "hi": "उसका मुँह एक तरफ टेढ़ा हो गया है",
        },
    ),
    (
        "de repente ve mal",
        "emergency",
        {
            "en": "he suddenly cannot see properly",
            "es": "de repente ve borroso y doble",
            "fr": "il voit soudain flou et double",
            "de": "er sieht plötzlich verschwommen und doppelt",
            "ru": "внезапно стал плохо видеть, двоится в глазах",
            "ar": "فجأة صار يرى بشكل ضبابي ومزدوج",
            "pt": "de repente está vendo embaçado e dobrado",
            "hi": "अचानक धुंधला और दोहरा दिखने लगा",
        },
    ),
    (
        "camina torcido",
    ...
    (
        ...
        "urgent",
        {
            "en": "it is very hard to wake him up today",
            "es": "hoy cuesta muchísimo despertarle",
            "fr": "il est très difficile à réveiller aujourd'hui",
            "de": "er ist heute sehr schwer zu wecken",
            "ru": "сегодня его очень трудно разбудить",
            "ar": "من الصعب جدا إيقاظه اليوم",
            "pt": "hoje está muito difícil acordá-lo",
            "hi": "आज उसे जगाना बहुत मुश्किल हो रहा है",
        },
    ),
    (
        "barriga que va a peor",
        "urgent",
        {
    ...
    (
        ...
        "urgent",
        {
            "en": "the baby is floppy and very lethargic",
            "es": "el bebé está muy flojo y decaído",
            "fr": "le bébé est tout mou et très abattu",
            "de": "das Baby ist schlaff und sehr matt",
            "ru": "ребёнок вялый и обмякший",
            "ar": "الطفل رخو وخامل جدا",
            "pt": "o bebê está molinho e muito abatido",
            "hi": "बच्चा ढीला और बहुत सुस्त है",
        },
    ),
]
