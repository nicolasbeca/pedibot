...
CASOS: dict[str, dict[str, str]] = {
    ...
    # ── África, fase 2 (18-sep-2026) ─────────────────────────────────────────────────
    # Las ocho reglas que trajo el continente. Medido antes de escribirlas: de 41 frases
    # con las que un padre africano cuenta lo que mata niños allí, 29 salían mal.
    # La palidez palmar no existía en ninguna lengua y la frecuencia respiratoria contada
    # —la herramienta del IMCI donde no hay radiografía— salía como rutina.
    "severe_malaria": {
        "es": "tiene malaria y está muy dormido, no se despierta",
        "en": "he has malaria and is very sleepy and hard to wake",
        "fr": "il a le paludisme et il est très somnolent",
        "de": "er hat Malaria und ist sehr schläfrig",
        "ru": "у него малярия и он очень вялый",
        "ar": "عنده ملاريا وهو خامل جدا",
        "pt": "ele tem malária e está muito sonolento",
        "hi": "उसे मलेरिया है और वह बहुत सुस्त है",
    },
    "malaria_area_fever": {
        "es": "tiene fiebre y vivimos en una zona de paludismo",
        "en": "she has a fever and we live in a malaria area",
        "fr": "il a de la fièvre et nous vivons en zone de paludisme",
        "de": "sie hat Fieber und wir leben in einem Malariagebiet",
        "ru": "у него температура, мы живём в малярийном районе",
        "ar": "عنده حمى ونحن في منطقة فيها ملاريا",
        "pt": "ela tem febre e vivemos numa zona de malária",
        "hi": "उसे बुख़ार है और हम मलेरिया वाले इलाक़े में रहते हैं",
    },
    "palmar_pallor": {
        "es": "tiene las palmas de las manos muy pálidas",
        "en": "his palms are very pale",
        "fr": "la paume de ses mains est très pâle",
        "de": "seine Handflächen sind sehr blass",
        "ru": "ладони очень бледные",
        "ar": "كفا يديه شاحبتان جدا",
        "pt": "as palmas das mãos estão muito pálidas",
        "hi": "उसकी हथेलियाँ बहुत पीली हैं",
    },
    "fast_breathing_for_age": {
        "es": "he contado 64 respiraciones por minuto",
        "en": "I counted 64 breaths per minute",
        "fr": "j'ai compté 64 respirations par minute",
        "de": "ich habe 64 Atemzüge pro Minute gezählt",
        "ru": "я насчитала 64 вдохов в минуту",
        "ar": "عددت 64 نفسا في الدقيقة",
        "pt": "contei 64 respirações por minuto",
        "hi": "मैंने एक मिनट में 64 साँस गिनीं",
    },
    "cholera_rice_water": {
        "es": "la caca es como agua de arroz",
        "en": "his stools are like rice water",
        "fr": "les selles sont comme de l'eau de riz",
        "de": "der Stuhl sieht aus wie Reiswasser",
        "ru": "стул как рисовый отвар",
        "ar": "البراز مثل ماء الأرز",
        "pt": "as fezes são como água de arroz",
        "hi": "मल चावल के पानी जैसा है",
    },
    "severe_dehydration_signs": {
        "es": "le pellizco la piel y tarda en volver",
        "en": "I pinch his skin and it goes back very slowly",
        "fr": "je pince la peau et elle revient très lentement",
        "de": "die Hautfalte bleibt stehen",
        "ru": "кожная складка расправляется медленно",
        "ar": "الجلد لا يعود بسرعة",
        "pt": "a pele demora a voltar",
        "hi": "त्वचा धीरे लौटती है",
    },
    "measles_complication": {
        "es": "tiene sarampión y los ojos con pus",
        "en": "he has measles and his eyes are full of pus",
        "fr": "il a la rougeole et les yeux pleins de pus",
        "de": "er hat Masern und Eiter im Auge",
        "ru": "у него корь и гной в глазу",
        "ar": "عنده حصبة وصديد في العين",
        "pt": "tem sarampo e os olhos com pus",
        "hi": "उसे खसरा है और आँख से मवाद आ रहा है",
    },
    "neonatal_tetanus": {
        "es": "mi recién nacido dejó de mamar y se ha puesto rígido",
        "en": "my newborn stopped feeding and has gone stiff",
        "fr": "le nouveau-né ne tète plus et il est raide",
        "de": "das Neugeborene trinkt nicht mehr und ist steif",
        "ru": "новорождённый перестал сосать и весь окоченел",
        "ar": "المولود توقف عن الرضاعة وتيبس جسمه",
...
def test_the_battery_covers_every_rule_there_is(triaje: Triage) -> None:
    ...
    sin_idioma = {
        r: sorted(set(IDIOMAS) - set(f)) for r, f in CASOS.items() if set(IDIOMAS) - set(f)
    }
...
def test_an_ordinary_day_stays_ordinary(triaje: Triage, lang: str, texto: str) -> None:
    ...
    assert r.level == "routine", (
        f"[{lang}] «{texto}» sale como {r.level}: {[m.id for m in r.matched]}"
    )
...
SEGUNDA: dict[str, dict[str, str]] = {
    ...
    # ── África, fase 2 (18-sep-2026): la otra forma de decirlo ───────────────────────
    # La segunda ataca por la otra pierna de cada regla: el paludismo por la orina oscura
    # en vez de por la somnolencia, el cólera por el nombre en vez de por el agua de arroz,
    # el tétanos por los espasmos en vez de por el dejar de mamar. Si la segunda fuera la
    # primera con una coma cambiada, esta batería pasaría sin comprobar nada (L174).
    "severe_malaria": {
        "es": "le diagnosticaron paludismo y ahora orina muy oscura",
        "en": "she was diagnosed with malaria and her urine is very dark",
        "fr": "il a le palu et ses urines sont très foncées",
        "de": "er hat Malaria und der Urin ist dunkel",
        "ru": "у него малярия и моча тёмная",
        "ar": "عنده ملاريا وبوله داكن",
        "pt": "tem malária e a urina está escura",
        "hi": "उसे मलेरिया है और पेशाब बहुत गहरा है",
    },
    "malaria_area_fever": {
        "es": "vivimos en zona de paludismo y lleva dos días con fiebre",
        "en": "we live in a malaria zone and he has had a fever for two days",
        "fr": "nous sommes en zone de paludisme et il a de la fièvre",
        "de": "wir leben in einem Malariagebiet und sie hat Fieber",
        "ru": "мы в малярийном районе, у ребёнка температура",
        "ar": "نحن في منطقة ملاريا والطفل عنده حمى",
        "pt": "vivemos numa zona de malária e ele tem febre",
        "hi": "हम मलेरिया क्षेत्र में रहते हैं और उसे बुख़ार है",
    },
    "palmar_pallor": {
        "es": "está pálido en la palma de la mano",
        "en": "he looks pale on the palms of his hands",
        "fr": "il est pâle à la paume des mains",
        "de": "blass an den Handflächen",
        "ru": "бледные ладони",
        "ar": "شحوب في كف اليد",
        "pt": "pálido nas palmas das mãos",
        "hi": "हथेली बहुत पीली दिखती है",
    },
    "fast_breathing_for_age": {
        "es": "respira 58 veces por minuto y tiene 6 meses",
        "en": "his breathing is 52 per minute, he is 9 months old",
        "fr": "il respire 46 fois par minute, il a 3 ans",
        "de": "sie atmet 48 mal pro Minute, sie ist 2 Jahre alt",
        "ru": "дышит 62 раза в минуту",
        "ar": "يتنفس 64 مرة في الدقيقة",
        "pt": "respira 55 vezes por minuto, tem 7 meses",
        "hi": "एक मिनट में 62 साँस चल रही हैं",
    },
    "cholera_rice_water": {
        "es": "hay cólera en el pueblo y tiene diarrea",
        "en": "there is cholera here and he has diarrhoea",
        "fr": "il y a le choléra ici et il a la diarrhée",
        "de": "hier gibt es Cholera und er hat Durchfall",
        "ru": "у нас холера и у него понос",
        "ar": "عندنا كوليرا وعنده إسهال",
        "pt": "há cólera na aldeia e ele tem diarreia",
        "hi": "यहाँ हैजा है और उसे दस्त है",
    },
    "severe_dehydration_signs": {
        "es": "tiene los ojos hundidos y no bebe nada",
        "en": "his eyes are sunken and he cannot drink",
        "fr": "les yeux sont enfoncés et il ne boit plus",
        "de": "die Augen sind eingefallen und sie trinkt nichts",
        "ru": "глаза запали и он не пьёт",
        "ar": "عيونه غائرة ولا يشرب",
        "pt": "os olhos estão encovados e não bebe nada",
        "hi": "आँखें धँसी हैं और कुछ नहीं पी रहा",
    },
    "measles_complication": {
        "es": "tiene sarampión y llagas en la boca",
        "en": "measles with mouth ulcers",
        "fr": "rougeole avec des ulcères dans la bouche",
        "de": "Masern mit Geschwüren im Mund",
        "ru": "корь и язвы во рту",
        "ar": "حصبة وتقرحات في الفم",
        "pt": "sarampo com úlceras na boca",
        "hi": "खसरा और मुँह में छाले",
    },
    "neonatal_tetanus": {
        "es": "mi bebé recién nacido tiene la mandíbula apretada",
        "en": "my newborn has spasms",
        "fr": "le nouveau-né a des spasmes",
        "de": "das Neugeborene hat Krämpfe",
        "ru": "у новорождённого спазмы",
