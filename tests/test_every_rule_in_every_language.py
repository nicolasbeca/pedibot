...
CASOS: dict[str, dict[str, str]] = {
    ...
    "eye_foreign_body_or_injury": {
        "es": "creo que tiene una astilla clavada en el ojo",
        "en": "he has a splinter stuck in his eye",
        "fr": "il a une écharde dans l'œil",
        "de": "er hat einen splitter im auge",
        "ru": "у него заноза в глазу",
        "ar": "دخلت شظية في عينه",
        "pt": "tem uma farpa espetada no olho",
        "hi": "उसकी आँख में काँच चला गया",
    },
    "fall_stairs_or_inconsolable": {
        "es": "se ha caído por las escaleras",
        "en": "she fell down the stairs",
        "fr": "il est tombé dans les escaliers",
        "de": "er ist die treppe hinuntergefallen",
        "ru": "упал с лестницы",
        "ar": "وقع من الدرج",
    ...
    "priapism": {
        "es": "mi hijo tiene una erección que no se le baja desde hace horas",
        "en": "my son has had an erection for hours",
        "fr": "mon fils a une érection depuis des heures",
        "de": "mein Sohn hat seit Stunden eine Erektion",
        "ru": "у сына эрекция уже несколько часов и не проходит",
        "ar": "ابني لديه انتصاب منذ ساعات",
        "pt": "o meu filho tem uma ereção há horas",
        "hi": "मेरे बेटे का इरेक्शन घंटों से है",
    },
    "paraphimosis": {
        "es": "el prepucio de mi hijo se ha quedado atascado detrás",
        "en": "my son's foreskin is stuck behind the head of his penis",
        "fr": "le prépuce de mon fils est coincé derrière le gland",
        "de": "die Vorhaut meines Sohnes ist hinter der Eichel eingeklemmt",
        "ru": "у сына крайняя плоть застряла за головкой",
        "ar": "القلفة عند ابني عالقة خلف رأس القضيب",
        "pt": "o prepúcio do meu filho ficou preso atrás da glande",
        "hi": "बेटे के लिंग की चमड़ी पीछे जाकर अटक गई है",
    },
    "sting_mouth_throat_eye": {
        "es": "le ha picado una abeja dentro de la boca",
        "en": "my son was stung by a wasp inside his mouth and it is swelling",
        "fr": "il s'est fait piquer par une guêpe dans la bouche",
        "de": "er wurde von einer Wespe im Mund gestochen",
        "ru": "его ужалила оса во рту",
        "ar": "لسعته نحلة في الفم",
        "pt": "foi picado por uma abelha na boca",
        "hi": "मधुमक्खी ने मुँह के अंदर डंक मारा",
    },
    "pale_stools": {
        "es": "mi bebé hace las cacas casi blancas",
        "en": "my baby's poo is very pale, almost white",
        "fr": "les selles de mon bébé sont blanches",
        "de": "der Stuhl meines Babys ist weiß",
        "ru": "у малыша стул почти белый",
        "ar": "براز طفلي أبيض",
        "pt": "as fezes do meu bebé estão brancas",
        "hi": "मेरे बच्चे का मल सफ़ेद है",
    },
    "headache_wakes_child": {
        "es": "a mi hijo le duele la cabeza y se despierta por la noche por el dolor",
        "en": "his headache wakes him up at night",
        "fr": "son mal de tête le réveille la nuit",
        "de": "sein Kopfschmerz weckt ihn nachts auf",
        "ru": "головная боль будит его ночью",
        "ar": "الصداع يوقظه ليلاً",
        "pt": "a dor de cabeça acorda-o de noite",
        "hi": "सिरदर्द उसे रात में जगा देता है",
    },
    "unexplained_bruising": {
        "es": "le salen moratones sin ningún golpe",
        "en": "he gets bruises with no knock at all",
        "fr": "il a des bleus sans aucun choc",
        "de": "er bekommt blaue Flecken ohne Sturz",
        "ru": "у него синяки без удара",
        "ar": "تظهر عليه كدمات بدون صدمة",
        "pt": "aparecem-lhe nódoas negras sem pancada",
        "hi": "उसे बिना चोट के नील पड़ जाते हैं",
    },
    "unequal_pupils": {
        "es": "tiene una pupila más grande que la otra",
        "en": "one pupil is bigger than the other",
        "fr": "il a une pupille plus grande que l'autre",
        "de": "eine Pupille ist größer als die andere",
        "ru": "один зрачок больше другого",
        "ar": "حدقة أكبر من الأخرى",
        "pt": "tem uma pupila maior que a outra",
        "hi": "उसकी एक पुतली दूसरी से बड़ी है",
    },
    "limp_after_fall": {
        "es": "se cayó ayer y ahora cojea",
        "en": "he fell yesterday and is limping now",
        "fr": "il est tombé hier et il boite depuis",
        "de": "er ist gestern gestürzt und hinkt seitdem",
        "ru": "он вчера упал и теперь хромает",
        "ar": "سقط أمس وهو يعرج بعد السقوط",
        "pt": "caiu ontem e agora manca",
        "hi": "वह कल गिरा और अब लंगड़ा रहा है",
    },
...
SEGUNDA: dict[str, dict[str, str]] = {
    ...
    "eye_foreign_body_or_injury": {
        "es": "le han dado un pelotazo en el ojo",
        "en": "he got poked in the eye with a stick",
        "fr": "il a reçu un coup dans l'œil",
        "de": "sie hat einen schlag aufs auge bekommen",
        "ru": "получил удар по глазу мячом",
        "ar": "تلقى ضربة على عينه",
        "pt": "levou uma pancada no olho",
        "hi": "उसकी आँख पर चोट लगी है",
    },
    "fall_stairs_or_inconsolable": {
        "es": "se cayó del columpio y no deja de llorar",
        "en": "he fell off the bed and won't stop crying",
        "fr": "elle est tombée et n'arrête pas de pleurer",
        "de": "er ist gestürzt und hört nicht auf zu weinen",
        "ru": "упал и не перестаёт плакать",
    ...
    "priapism": {
        "es": "tiene una erección muy dolorosa",
        "en": "he has a painful erection that won't go away",
        "fr": "il a une érection douloureuse",
        "de": "er hat eine schmerzhafte Erektion",
        "ru": "у мальчика болезненная эрекция",
        "ar": "عنده انتصاب مؤلم",
        "pt": "ele tem uma ereção dolorosa",
        "hi": "उसे दर्द वाला इरेक्शन हो रहा है",
    },
    "paraphimosis": {
        "es": "le bajé la piel y ahora el prepucio no vuelve",
        "en": "the foreskin won't go back after bathing him",
        "fr": "après le bain son prépuce ne revient pas",
        "de": "nach dem Baden geht die Vorhaut nicht zurück",
        "ru": "после купания крайняя плоть не возвращается",
        "ar": "بعد الحمام القلفة لا تعود مكانها",
        "pt": "depois do banho o prepúcio não volta",
        "hi": "नहलाने के बाद चमड़ी वापस नहीं आ रही",
    },
    "sting_mouth_throat_eye": {
        "es": "le ha picado un mosquito cerca del ojo",
        "en": "she got stung near her eye",
        "fr": "elle s'est fait piquer près de l'œil",
        "de": "sie wurde am Auge gestochen",
        "ru": "её ужалила пчела возле глаза",
        "ar": "لدغتها حشرة قرب العين",
        "pt": "foi picada perto do olho",
        "hi": "आँख के पास डंक लगा है",
    },
    "pale_stools": {
        "es": "mi hijo hace las heces de color masilla desde hace días",
        "en": "she has chalky stools",
        "fr": "ses selles sont très pâles",
        "de": "sein Stuhl ist ganz hell und entfärbt",
        "ru": "кал светлый уже три дня",
        "ar": "البراز شاحب منذ أيام",
        "pt": "as fezes estão muito pálidas",
        "hi": "मल बहुत हल्का और फीका है",
    },
    "headache_wakes_child": {
        "es": "le duele la cabeza nada más despertarse cada mañana",
        "en": "he has a headache first thing in the morning",
        "fr": "il a mal à la tête au réveil",
        "de": "er hat Kopfschmerzen beim Aufwachen",
        "ru": "голова болит по утрам, когда просыпается",
        "ar": "عنده صداع عند الاستيقاظ",
        "pt": "tem dor de cabeça ao acordar",
        "hi": "उसे सुबह उठते ही सिरदर्द होता है",
    },
    "unexplained_bruising": {
        "es": "tiene moratones en la espalda y no recuerdo ningún golpe",
        "en": "she has bruises on her back without any injury",
        "fr": "elle a des bleus sans raison, je ne me souviens d'aucun choc",
        "de": "sie hat blaue Flecken ohne Grund, ich erinnere mich an keinen Sturz",
        "ru": "у неё синяки без причины, я не помню удара",
        "ar": "عندها كدمات بدون سبب ولا أذكر أي صدمة",
        "pt": "tem hematomas sem motivo, não me lembro de nenhuma pancada",
        "hi": "उसके शरीर पर बिना चोट के नील हैं, मुझे याद नहीं कोई गिरना",
    },
    "unequal_pupils": {
        "es": "le veo una pupila dilatada desde esta tarde",
        "en": "her pupil looks more dilated than the other one",
        "fr": "sa pupille est dilatée par rapport à l'autre",
        "de": "eine Pupille ist weiter als die andere",
        "ru": "зрачок шире другого",
        "ar": "بؤبؤ أوسع من الآخر",
        "pt": "o meu filho tem uma pupila mais dilatada do que a outra",
        "hi": "उसकी पुतली फैली हुई दिख रही है",
    },
    "limp_after_fall": {
        "es": "no apoya la pierna desde que se cayó en el parque",
        "en": "he is not putting weight on his leg since the fall",
        "fr": "il boite depuis sa chute au parc",
        "de": "er humpelt seit dem Sturz auf dem Spielplatz",
        "ru": "он хромает после падения в парке",
        "ar": "يعرج بعد سقوطه في الحديقة",
        "pt": "manca desde a queda no parque",
        "hi": "पार्क में गिरने के बाद वह लंगड़ा रहा है",
    },
    "vomiting_after_head_injury": {
