...
| reglas de alarma | **92** | config/red_flags.yaml |
...
| documentos del catálogo público | **570** | dataset/sources.json (CC0) |
| documentos del catálogo interno | **573** | incluye los que no se pueden redistribuir |
| guías publicadas | **507** | web/content/*/*.md |
| pruebas automáticas | **9.932** | `uv run pytest --collect-only` |
