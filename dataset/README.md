...
**491 documents from 21 organisations**, in 8 languages, each classified by topic and linked to its original.
...
| `year` | where the document states one (178 of 491 do) |
...
| `url` | link to the original (443 of 491 are online; the rest are books and printed manuals, identified in `notes`) |
