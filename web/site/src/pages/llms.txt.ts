...
export async function GET(context: APIContext) {
  ...
  const lines: string[] = [
    ...
    '',
    '1. **Every clinical sentence names the document it came from.** The organisation, the title',
    '   and the page. A reader who wants to check us can open the source and check us.',
