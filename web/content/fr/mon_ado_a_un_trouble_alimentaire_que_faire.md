---
title: "Mon ado a un trouble alimentaire : que faire ?"
description: "Comprendre les signes d’un TCA et savoir comment aider votre enfant à la maison."
lang: fr
topic: tca
date: 2026-09-02
...
- Évitez les commentaires sur son poids et son image corporelle [7].
- Évitez les conversations sur la nourriture, les régimes ou le poids ; proposez plutôt des activités d’intérêt pour le distraire [7].
- Favorisez un environnement sain et calme pendant les repas, avec une alimentation équilibrée à la maison [7]. Il est recommandé de faire cinq prises alimentaires par jour (petit-déjeuner, collation du matin, déjeuner, goûter et dîner), assis et avec les personnes habituelles du domicile [7].

Soyez attentifs aux signes d’alerte, notamment [2][4] :
- Changements dans les habitudes alimentaires, rituels étranges avec la nourriture [4].
- Exercice physique excessif [4].
- Obsession de se peser continuellement [4].
- Aller aux toilettes ou dans sa chambre immédiatement après les repas [4].
- Achat et consommation de produits amaigrissants [4].
- Commentaires dévalorisants sur son propre corps, préoccupation extrême pour la silhouette, les régimes et le poids [2].
- Faible estime de soi, distorsion de l’image corporelle [2].
- Instabilité émotionnelle, isolement, irritabilité et impulsivité [2].
...
- Refus de s’alimenter depuis 24 heures ou plus [3].
- Troubles graves du comportement [3].
...
**Dois-je parler de nourriture avec mon enfant ?**
Il est préférable d’éviter les conversations sur la nourriture, les régimes ou le poids, car votre enfant y pense déjà constamment [7]. Proposez plutôt des activités de distraction [7].

**Les TCA touchent-ils aussi les garçons ?**
