---
title: "My child has an ear infection, what should I do?"
description: "Ear infections are common in children and often get better on their own within a few days. Here is what you can do at home and when to get medical help."
lang: en
topic: ear_infection
date: 2026-09-02
...
sources:
  ...
  - "[9] NHS — \"Ear infections\" (2025), section \"How an ear infection is diagnosed\", p. 1 — https://www.nhs.uk/conditions/ear-infections/"
draft: false
---
...
- Use painkillers such as paracetamol or ibuprofen (children under 16 should not take aspirin) [7]
- Remove any discharge by wiping the ear with cotton wool [7]
- Let your child rest and drink extra water or other fluids [6]
- Ask your healthcare provider about over-the-counter medicines for pain or fever, and always use them as directed [6]

There are also things you should not do:
- Do not put anything inside the ear to remove earwax, such as cotton buds or your finger [1]
- Do not let water or shampoo get in the ear [1]
- Do not go swimming while you have an ear infection [1]
...
- Have fluid coming out of the ear
...
A GP or pharmacist may use an instrument with a small light and magnifying glass (an otoscope) to look in the ear [9]. Some otoscopes blow a small puff of air into the ear to check for blockages, which could be a sign of an infection [9].

**What if my child gets ear infections often?**
