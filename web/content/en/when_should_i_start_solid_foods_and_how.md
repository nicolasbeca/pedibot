---
title: "When should I start solid foods and how?"
description: "Start complementary foods around 6 months, one food at a time, and keep breastfeeding on demand."
lang: en
...
- Do not set a fixed amount your baby “must” eat. Amounts vary between babies and by circumstance [6].
- Respect hunger and fullness cues. Parents decide where, when, and what the child eats. The child decides how much [6].
- Forcing or coercing a child to eat increases family dissatisfaction and the risk of eating problems [6].
- Set routines: a calm place without distractions like TV or phones, sit the child facing family members, and use a safe high chair or lap [6].
- Aim for about 4–5 feedings a day as a rough guide [6].
- Serve varied, healthy food in portions appropriate for age and growth [6].
- Stay patient with new skills. Keep a neutral attitude when the child does not eat or does not like something. Do not show anger [6].
- Avoid screens and toys during meals [6].
- Enjoy family meals and reinforce achievements. Do not use food as rewards, punishments, comfort, or bribery [6].
- If using baby-led weaning, offer food as finger foods or sticks at first so the baby can grip with their fist and eat what sticks out. As motor skills improve, offer safe foods cut into small pieces [5].
...
Look for active interest in food, loss of the tongue-thrust reflex, ability to pick up food and bring it to the mouth, and sitting with support [4]. These usually appear around 6 months [4].

**What foods should I start with?**
Offer foods rich in iron and zinc first [1]. There are no foods better than others to start with [1]. Introduce foods one at a time with days between each [1]. Do not add salt, sugar, or sweeteners [1].
