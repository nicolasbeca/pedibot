---
title: "What is pneumonia in kids and what can I do at home?"
description: "Pneumonia is a lung infection that usually gets better at home with rest, fluids, and fever medicine."
lang: en
topic: neumonia
date: 2026-09-02
...
- Keep your child semi-upright for sleeping [4].
- Give fever medicine (ibuprofen or paracetamol) if there is fever with discomfort or pain [4].
- If an antibiotic was prescribed, follow the dose, interval, and duration correctly [4].
- Keep the room humidified and well ventilated, free of tobacco smoke [4].
- Do not give cough-suppressing syrups, because coughing is the main way to clear secretions [4]. Mucolytics and expectorants are also not recommended [4].
- If your child feels well and has no fever, they can go back to school [5]. If there is fever, wait at least 24 hours without it [5].
...
- Breathing difficulty: breathing fast, ribs showing, belly moving a lot, chest sinking in [6].
- Chest or side pain when breathing [6].
- Poor color [6].
- Cannot tolerate the prescribed treatment [6].
- Persistently refuses food and fluids [6].
...
The most effective measures are frequent hand washing with soap and water or alcohol solutions, using disposable tissues, and adequate ventilation at home [6]. Routine vaccination, including the flu vaccine, also protects against pneumonia [6]. Vaccination against Hib, pneumococcus, measles, and whooping cough is the most effective way to prevent pneumonia [10]. Good nutrition, starting with exclusive breastfeeding for the first six months, helps improve natural defenses [10]. Correcting environmental factors like indoor air pollution also helps [10].
