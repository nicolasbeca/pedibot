---
title: "My child is having an asthma attack, what do I do?"
description: "Learn how to recognize an asthma attack, what to do at home with salbutamol, and when to seek urgent medical care."
lang: en
topic: crisis_asma
date: 2026-09-02
...
- Repeat this dose after 10 to 15 minutes [4].
- Always use a spacer chamber with the inhaler, never directly in the mouth, as it works less effectively that way [1].
- Keep your child at rest and avoid vigorous exercise [4].
- Avoid environments with tobacco smoke or pollution [4].
- You can treat associated symptoms like fever with fever-reducing medication [4].
- If your child takes daily maintenance treatment, continue it during the attack [4].

Symptoms usually resolve within a few days but can last up to a week [2]. Avoid exercise during the attack [2]. For children with allergies, also avoid allergen exposure during the crisis [2].
...
- Turns purple or pale [1]
- Breathing gets worse: breathing faster and faster, ribs becoming visible, moving the abdomen a lot, or chest sinking in [1]
- Needs inhalations very frequently, every two hours or less [1]
- Breathing is faster than normal [5]
- Lips turn purple or child looks pale [5]
- Child becomes increasingly listless and less active, with difficulty talking or eating [5]
- Has a great feeling of shortness of breath, continuous cough, or trouble speaking [6]
- Bluish color appears around the lips [6]
...
**When can my child return to school or exercise?**
It is recommended to avoid physical exercise during the asthma attack [2]. Children with repeated attacks should carry their inhaler to school [2].

**What happens if the attack is severe?**
