---
title: "Insect bites: what helps and when to worry"
description: "Most insect bites are harmless and get better in a few days. Here is how to treat them at home and when to get medical help."
lang: en
topic: insect_bites
date: 2026-09-02
...
- Use fine-tipped tweezers or a tick-removal tool to grasp a tick as close to the skin as possible. Pull slowly upwards. Do not squeeze the tick [4].
- Gently remove a caterpillar with tweezers or a pen. Try not to disturb it [4].

After removing anything, wash the area with soap and water [3][4]. Keep insect bites clean to help prevent infections like impetigo [6].

To ease symptoms:

- Put an ice pack wrapped in a cloth, or a clean cloth soaked in cold water, on the bite for at least 20 minutes if it is swollen [3].
- Keep the area raised if you can [3].
- Take painkillers such as paracetamol or ibuprofen if the sting is painful [3].
- Use antihistamines to relieve itching. Do not use antihistamine cream if caterpillar hairs were on the skin [3].
- Use hydrocortisone cream to reduce itching and swelling [3].
...
- It is painful [5].
- The area looks swollen [5].
- There is pus or fluid coming out [5].
...
- There is tummy pain and vomiting [5].
- Your child feels dizzy or lightheaded [5].
- There is a high temperature and swollen glands [5].
...
- Throat feels tight or trouble swallowing [5].
- Skin, tongue, or lips turn blue, grey, or pale. On brown or black skin, this may be easier to see on the palms or soles [5].
- Sudden confusion, drowsiness, or dizziness [5].
- Faints and cannot be woken up [5].
...
Symptoms include a tickling feeling in the hair, frequent itching from an allergic reaction to bites, sores from scratching, and trouble sleeping [7]. Diagnosis usually comes from seeing a louse or nit. Use a magnifying lens and fine-toothed comb to find them [7].

**Can an insect bite cause impetigo?**
