---
title: "What should I do if my child gets a burn or scald?"
description: "Cool the burn with running water right away, then cover it loosely. Get emergency help for large, deep, or chemical burns."
lang: en
topic: burns
date: 2026-09-02
...
- Third-degree burns damage or destroy the deepest layer of skin and tissues underneath [5]
...
- Remove any clothing or jewellery near the affected area, but do not remove anything stuck to the skin [1].
- After the burn has cooled, lay cling film over it. Do not wrap the cling film around the area [1].
- Give painkillers such as paracetamol or ibuprofen to help with pain [4].
- Use an emollient ointment on the area if it becomes itchy and dry as it heals. Ask a pharmacist for advice [4].

Do not do these things:
- Do not put creams, oils, or butter on burns or scalds [4].
- Do not use plasters or sticky dressings to cover a burn or scald [4].
...
No. Do not put creams, oils, or butter on burns or scalds [4]. These can trap heat and increase the risk of infection.

**What if clothing is stuck to the burn?**
Remove clothing near the area, but do not remove anything that is stuck to the affected area [1]. Leave it in place and get medical help.

**Is a scald different from a burn?**
