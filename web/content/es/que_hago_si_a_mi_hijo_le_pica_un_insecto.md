---
title: "¿Qué hago si a mi hijo le pica un insecto?"
description: "Guía práctica para aliviar picaduras y mordeduras de insectos en niños y saber cuándo buscar ayuda médica."
lang: es
topic: insect_bites
date: 2026-09-02
...
- Déle analgésicos como paracetamol o ibuprofeno si la picadura duele [3].
- Use antihistamínicos para aliviar el picor (pero no use crema de antihistamínicos si hubo pelos de oruga en la piel) [3].
- Use una crema de hidrocortisona para reducir el picor y la hinchazón [3].

Si queda algo en la piel, retírelo con cuidado [4]:
- Para un aguijón: raspe o cepille el aguijón de lado con la uña o el borde de una tarjeta. No use pinzas, ya que podría exprimir veneno [4].
- Para una garrapata: use pinzas de punta fina o una herramienta especial, agarre la garrapata lo más cerca posible de la piel y tire lentamente hacia arriba, sin apretarla ni dejar la boca dentro [4].
- Para una oruga: retírela suavemente con pinzas o un bolígrafo, sin molestarla. Enjuague la piel con agua corriente y déjela secar al aire. Use cinta adhesiva para recoger los pelos restantes [4].
- Lave la zona con agua y jabón o antiséptico después [4].
- Quítese las joyas por si la piel se hincha, y lave la ropa a alta temperatura [4].

No haga:
- No rasque la picadura, ya que podría infectarse [5].
- No use remedios caseros como bicarbonato de sodio [5].

## Cuándo acudir al médico o a urgencias
Consulte a un farmacéutico si su hijo tiene 1 año o más y la piel alrededor de la picadura está caliente al tacto o se ve roja (el enrojecimiento puede ser más difícil de ver en piel morena o negra), le duele, se ve hinchada, o sale pus o líquido [5].

Acuda a un médico de cabecera si:
...
- Se siente mareado o aturdido [5].
- Tiene fiebre alta y ganglios inflamados [5].
...
- La piel, la lengua o los labios se ponen azules, grises o pálidos [5].
- Se confunde, se adormece o se marea de repente [5].
- Alguien se desmaya y no se despierta [5].
- Un niño está flácido, no responde como de costumbre, o le cuesta levantar la cabeza o fijar la vista [5].

Estos pueden ser signos de una reacción alérgica grave que necesita tratamiento hospitalario inmediato [5].

## Preguntas frecuentes
¿Cómo sé si mi hijo tiene piojos?
Los síntomas incluyen sensación de cosquilleo en el cabello, picor frecuente (causado por una reacción alérgica a las picaduras), llagas por rascarse que pueden infectarse, y problemas para dormir porque los piojos son más activos en la oscuridad [7]. El diagnóstico suele hacerse al ver un piojo o una liendre; use una lupa y un peine de púas finas [7].

¿Las picaduras pueden causar impétigo?
