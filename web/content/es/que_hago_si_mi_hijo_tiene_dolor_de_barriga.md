---
title: "¿Qué hago si mi hijo tiene dolor de barriga?"
description: "Guía práctica para padres sobre el dolor abdominal en niños: qué es, qué hacer en casa y cuándo acudir a urgencias."
lang: es
...
sources:
  - "[1] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿QUÉ ES EL DOLOR ABDOMINAL?\", pág. 1"
  - "[2] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿CUÁNDO PUEDE VOLVER A LA GUARDERÍA/ ESCUELA? ¿CUÁNDO PUEDE REALIZAR ACTIVIDAD FÍSICA?\", pág. 1"
  - "[3] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿CÓMO LO PODEMOS PREVENIR?\", pág. 2"
  - "[4] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿QUÉ PODEMOS HACER EN CASA?\", pág. 1"
  - "[5] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"DOLOR ABDOMINAL\", pág. 2"
  - "[6] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿CUÁLES SON LOS SÍNTOMAS?\", pág. 1"
  - "[7] SEUP — \"Dolor abdominal. Información para padres\" (2025), sección \"¿DEBEMOS OFRECERLE ALGUNA ALIMENTACIÓN ESPECIAL?\", pág. 1"
  - "[8] SEUP — \"Vómitos. Información para padres\" (2025), sección \"¿QUÉ SÍNTOMAS DEBEMOS VIGILAR EN CASA QUE NOS PUEDEN INDICAR QUE ESTÁ PEOR? Y ¿CUÁNDO DEBEMOS CONSULTAR EN UN SERVICIO DE URGENCIAS?\", pág. 2"
  - "[9] SEUP — \"Estreñimiento. Información para padres\" (2025), sección \"¿PODEMOS OFRECERLE ALGUNA ALIMENTACIÓN ESPECIAL?\", pág. 1, 2"
  - "[10] SEUP — \"Gastroenteritis aguda. Información para padres\" (2025), sección \"Ofrecer en pequeñas cantidades SRO Dolor abdominal\", pág. 2"
draft: false
---
...
- Si el niño se queja habitualmente de dolor abdominal, sobre todo por las mañanas, es importante que no deje de ir al colegio [4].
- En general, se recomienda una dieta suave, apetecible, baja en grasas y sin forzar la ingesta [7]. Si el bebé toma pecho o biberón, puede seguir tomándolos [7]. Si está inapetente, se puede ofrecer pequeñas cantidades de líquido en forma de suero de rehidratación oral [7].
...
- El dolor se hace continuo, cada vez más intenso, de tal manera que el niño no mantiene su actividad habitual o duerme mal [5].
- El dolor lo refiere un niño menor de 4-5 años; es recomendable su valoración en atención primaria [5].
- El dolor se localiza en el lado derecho del abdomen o se aleja de la zona periumbilical [5].
- Vómitos continuos, verdosos, marrones o con sangre [5].
- Deposiciones negras, como alquitrán, o con sangre roja [5].
- El abdomen está tenso, duro o hinchado [5].
- Ha sido operado de abdomen previamente [5].
- Presenta drepanocitosis [5].
- Antecedentes conocidos o posibles de haber ingerido un cuerpo extraño punzante, una pila de botón o más de un imán [5].
- Dolor intenso tras un traumatismo abdominal [5].
- Si el niño es menor de 3 meses y ha vomitado dos o más tomas [8].
- Si vomita mucho, no tolera sólidos ni líquidos, o vomita aunque no tome nada [8].
- Si presenta adormilamiento, decaimiento, mucha sed, ojos hundidos, llora sin lágrimas u orina poco [8][10].
- Si tiene dolor abdominal intenso o dolor de cabeza [8].
- Si las deposiciones son muy líquidas, abundantes y frecuentes, de tal manera que el niño no es capaz de beber al mismo ritmo que pierde [10].
- Rechazo a comer o beber [10].
- Dolor abdominal persistente o intenso o deposiciones con mucha sangre [10].
...
No administre laxantes, enemas, ni medicamentos para la diarrea o los vómitos sin consultar con su pediatra [9][10]. No use soluciones caseras ni refrescos comerciales para reponer las pérdidas producidas por gastroenteritis [10]. Lo más importante es evitar la deshidratación mediante soluciones de rehidratación oral ya preparadas [10].
