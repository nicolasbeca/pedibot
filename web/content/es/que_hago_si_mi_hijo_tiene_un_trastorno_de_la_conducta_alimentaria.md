---
title: "¿Qué hago si mi hijo tiene un trastorno de la conducta alimentaria?"
description: "Guía práctica para entender los TCA, detectar las señales de alarma y saber cómo ayudar a tu hijo en casa."
lang: es
topic: tca
date: 2026-09-02
...
- Ofrece tu apoyo y acompañamiento durante el proceso. Proporciona un espacio seguro donde pueda expresar sus miedos y dificultades.
- Evita comentarios sobre su peso e imagen corporal. Suelen tener una vivencia de la realidad distorsionada de sí mismos y pueden estar susceptibles ante estos comentarios.
- Evita conversaciones sobre comida, dietas o el peso. Mejor facilita la distracción y propón otras actividades de su interés.
...
- Síncopes, convulsiones o hipoglucemias.
- Negativa a la ingesta de 24 horas de evolución o más.
...
- Pérdida de peso o cambios bruscos.
- Anomalías dentarias (pérdida de la capa de esmalte, caries).
- Descalcificación de los huesos.
- Mejillas hinchadas por conductas purgativas autoinducidas.
- Lanugo (vello fino, como el de los bebés, en zonas donde no lo había).

**¿Qué cambios psicológicos debo observar?**
Los signos psicológicos incluyen [2]:
- Comentarios despectivos sobre el propio cuerpo.
- Preocupación extrema por la figura, la dieta y el peso.
- Baja autoestima.
- Distorsión de la imagen corporal.
- Inestabilidad emocional, aislamiento, irritabilidad e impulsividad.
- Perfeccionamiento e insatisfacción.
- Aumento de la rigidez y la obsesión.

**¿Qué cambios de conducta pueden indicar un problema?**
