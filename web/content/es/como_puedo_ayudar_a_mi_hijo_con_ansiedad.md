---
title: "¿Cómo puedo ayudar a mi hijo con ansiedad?"
description: "Guía práctica para padres sobre cómo reconocer y manejar la ansiedad en niños y adolescentes, y saber cuándo buscar ayuda."
lang: es
topic: ansiedad
date: 2026-09-02
...
sources:
  - "[1] SEUP — \"Ansiedad. Información para padres\" (2025), sección \"¿QUÉ ES LA ANSIEDAD?\", pág. 1"
  - "[2] SEUP — \"Ansiedad. Información para padres\" (2025), sección \"GUÍA INFORMATIVA PARA LA DETECCIÓN, PREVENCIÓN Y MANEJO DE LA ANSIEDAD\", pág. 1"
  - "[3] SEUP — \"Ansiedad. Información para padres\" (2025), sección \"Signos y síntomas\", pág. 2"
  - "[4] SEUP — \"Ansiedad. Información para padres\" (2025), sección \"SE RECOMIENDA ACUDIR AL SERVICIO DE URGENCIAS PEDIÁTRICAS DE LA ZONA EN CASO\", pág. 2"
  - "[5] SEUP — \"Ansiedad. Información para padres\" (2025), sección \"EN EL CASO DE UN FAMILIAR, ¿CÓMO PUEDO AYUDAR A LA PERSONA SI DETECTO ESTAS SEÑALES?\", pág. 1"
  - "[6] WHO — \"La salud mental de los adolescentes\", sección \"Trastornos emocionales\", pág. 1 — https://www.who.int/es/news-room/fact-sheets/detail/adolescent-mental-health"
  - "[7] WHO — \"La salud mental de los adolescentes\", sección \"Datos y cifras\", pág. 1 — https://www.who.int/es/news-room/fact-sheets/detail/adolescent-mental-health"
  - "[9] WHO — \"La salud mental de los adolescentes\", sección \"Detección y tratamiento tempranos\", pág. 1 — https://www.who.int/es/news-room/fact-sheets/detail/adolescent-mental-health"
draft: false
---
...
- Sensación de peligro inminente, pánico o catástrofe [2]
- Nerviosismo, agitación o tensión [2]
- Dificultad para concentrarse o conciliar el sueño [2]
- Aumento del ritmo cardíaco [2]
- Presión o dolor en el pecho [2]
...
- Ofrece un entorno seguro y de calma, sin juzgar y evitando reaccionar de la misma manera que él o ella [5].
- Evita decirle que se calme. Es contraproducente y puede aumentar la ansiedad y la frustración [5].
- Valida sus sentimientos sin minimizarlos. Evita frases como “No tienes razón para estar preocupado”. En su lugar, di “Entiendo que eso te preocupa mucho, ¿quieres hablar más sobre ello?” [5].
- Acompáñalo durante el episodio de crisis. Muestra tu apoyo con frases como “Si me necesitas, aquí estoy, no estás solo/a” [5].
- Si presenta síndrome de hiperventilación con hormigueo en extremidades y cara, así como mareo, ofrécele una bolsa de papel para que respire dentro de ella [3].
...
- Si persiste la clínica de ansiedad aguda pese a intentar aplicar técnicas que previamente habían resultado efectivas [4].
...
**¿Qué pasa si la ansiedad no se trata?**
Cuando un trastorno de salud mental de un adolescente no se trata, sus consecuencias se extienden a la edad adulta, perjudican la salud física y mental de la persona y limitan sus posibilidades de llevar una vida plena en el futuro [7]. La depresión puede llevar al suicidio [6].
