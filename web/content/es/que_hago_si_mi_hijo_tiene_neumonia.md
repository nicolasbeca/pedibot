---
title: "¿Qué hago si mi hijo tiene neumonía?"
description: "Guía práctica para cuidar en casa a un niño con neumonía y saber cuándo acudir a urgencias."
lang: es
topic: neumonia
date: 2026-09-02
...
- Favorezca la posición semiincorporada para dormir [4].
- Administre antitérmico (ibuprofeno o paracetamol) si tiene fiebre con malestar o dolor [4]. Use la calculadora de dosis para saber cuánto dar.
- Si le han indicado antibiótico, cumpla correctamente la pauta: dosis, intervalo y duración [4].
- Mantenga el ambiente humidificado, con ventilación frecuente y libre de humo [4].
- No administre jarabes para frenar la tos (antitusivos), porque la tos es el principal mecanismo para eliminar las secreciones [4]. Tampoco se recomiendan mucolíticos ni expectorantes [4].
...
- Dificultad respiratoria: respira deprisa, se le marcan las costillas, mueve mucho el abdomen o se le hunde el pecho [6].
- Dolor en el pecho o el costado al respirar [6].
- Mal color [6].
- No tolera el tratamiento pautado [6].
- Rechaza la alimentación y los líquidos de forma persistente [6].

Si se ha indicado antibiótico y persiste la fiebre pasadas 48-72 horas, debe acudir a control en su centro de salud [2]. Las complicaciones son poco frecuentes, pero vigile el mal estado general, la dificultad para respirar o el dolor en el pecho o costado al respirar [2].
...
**¿Son necesarios los antibióticos siempre?** No. En menores de 2 años, la causa más habitual son los virus, por lo que el antibiótico no siempre es necesario [3]. Solo el pediatra decide si hace falta.
