---
title: "Mi hijo se autolesiona, ¿qué hago?"
description: "Guía para entender la conducta autolesiva no suicida y saber cómo actuar en casa."
lang: es
topic: autolesion
date: 2026-09-02
...
- Llevar ropa no adecuada a la estación del año o usar vendajes.
- Tener lesiones continuas injustificables (cortes, quemaduras, etc.).
- Necesitar privacidad de manera frecuente.
- Negarse a actividades que impliquen cambiarse de ropa (natación, etc.).
...
- ¿Hay algo que te preocupe ahora, algo en lo que yo te pueda ayudar?

Si rechaza hablar del tema, tenga paciencia y no fuerce la conversación [5]. Si valora que puede estar en riesgo, aumente la supervisión y el acompañamiento, retirando de su alcance objetos de riesgo como cúter, tijeras o cuchillas [5]. Puede fomentar alternativas positivas para disminuir la frecuencia de la autolesión [2], como [5]:

- Hacer deporte.
- Practicar mindfulness o técnicas de relajación.
- Buscar actividades de agrado (música, dibujar, leer).
...
- Hay malestar emocional significativo y persistente.
- El método es potencialmente peligroso (como cortarse).
- Hay alta sensibilidad al rechazo social.
