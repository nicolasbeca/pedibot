---
title: "¿Qué hago si mi hijo tiene una convulsión por fiebre?"
description: "Guía práctica sobre qué es una convulsión febril, cómo actuar en casa y cuándo buscar ayuda urgente."
lang: es
...
- Protege su cabeza con tus manos o algo suave [5].
- Retira cualquier objeto peligroso cercano [5].
- No introduzcas nada en su boca [2][7].
- No lo muevas ni intentes sujetarlo [7].
- No intentes bajar su temperatura desvistiéndolo o mojándolo con agua fría [7].
- Llama a los servicios de emergencia, mejor en manos libres, sin separarte del niño [2].
- Fíjate en los movimientos y en cuánto dura la convulsión [2].
- Anota la hora en que empieza y termina [5].

Cuando la convulsión ceda, colócalo en posición lateral de seguridad [2][5]. Si no le has dado medicina para la fiebre en las últimas 2 horas, puedes administrarle un antitérmico como paracetamol o ibuprofeno [2]. Si no es la primera vez y el médico le recetó una medicación para convulsiones, adminístrala si lleva más de tres minutos convulsionando [2].
...
- La convulsión dura más de 5 minutos [6].
- Tiene dificultad para respirar [6].
- Rigidez y sacudidas solo en un lado del cuerpo [6].
- Tiene más de una convulsión en 24 horas [6].
- Está más somnoliento de lo normal durante más de 1 hora después de la convulsión [6].
