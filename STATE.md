...
| Tests | ✅ **132 tests verdes**, ruff + mypy limpios. | `tests/` |
...
- **Sin VPS** (dominio pedibot.xyz comprado, Cloudflare). De las ideas aceptadas faltan: I-30 suero (necesita fuente nueva), I-26 selector de idioma (hoy: enlace EN/ES en la barra), T-06 Virtuals ACP, W-06 pediatras revisores. Hechas el 25-ago: diario+recordatorio, checklist urgencias, explícaselo a mi hijo, voz, mapa, temporada, compartir, 685 páginas de dosis SEO por idioma, /support, /legal.
