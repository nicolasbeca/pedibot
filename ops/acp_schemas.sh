...
VAC_REQ='{"type":"object","required":["country"],"description":"Which country schedule you want.","properties":{"country":{"type":"string","description":"ISO 3166-1 alpha-2. Transcribed schedules available: ES, GB, US, FR, DE"}}}'
