...
ASK_REQ='{"type":"object","required":["question"],"description":"One paediatric question from a parent, plus the language and country used to answer it.","properties":{"question":{"type":"string","description":"The question as a parent would ask it, e.g. my 3 year old has a barking cough"},"lang":{"type":"string","enum":["en","es","fr"],"default":"en","description":"Language of the answer: en, es or fr. The sources are quoted whatever language they were written in."},"country":{"type":"string","default":"GB","description":"ISO 3166-1 alpha-2, used to name the right emergency number in the banner"}}}'
...
VAC_REQ='{"type":"object","required":["country"],"description":"Which country schedule you want.","properties":{"country":{"type":"string","description":"ISO 3166-1 alpha-2. Transcribed schedules available: ES, GB, US, FR, DE"},"lang":{"type":"string","enum":["en","es","fr"],"default":"en","description":"Language of the answer: en, es or fr. The sources are quoted whatever language they were written in."}}}'
...
ORS_REQ='{"type":"object","required":["weight_kg"],"description":"The weight and age of the child who is vomiting or has diarrhoea.","properties":{"weight_kg":{"type":"number","description":"The child weight in kilograms"},"age_months":{"type":"integer","description":"Age in months: under and over one year get different volumes"},"lang":{"type":"string","enum":["en","es","fr"],"default":"en","description":"Language of the answer: en, es or fr. The sources are quoted whatever language they were written in."}}}'
