...
systemctl enable --now pedibot-api.service pedibot-telegram.service pedibot-acp.service pedibot-watchdog.timer pedibot-backup.timer pedibot-token.timer pedibot-sources.timer pedibot-tweets.timer pedibot-indexnow.timer pedibot-gsc.timer pedibot-social-project.timer pedibot-social-guides.timer pedibot-publish.timer pedibot-stats.timer >/dev/null 2>&1 || true
